            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="panel panel-danger">
                        <div class="panel-heading">Moletom Mackenzie FCI Vinho</div>
                        <div class="panel-body"><img src="${pageContext.request.contextPath}/img/vinho.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
                        <div class="panel-footer">R$120,00</div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="panel panel-danger">
                        <div class="panel-heading">Moletom Mackenzie FCI Preto</div>
                        <div class="panel-body"><img src="${pageContext.request.contextPath}/img/preto.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
                        <div class="panel-footer">R$120,00</div>
                    </div>
                </div>
            </div>
